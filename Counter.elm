...
view model =
    div []
        ...
        , div []
            [ span [ labelStyle ] [ text "MAX: "]
            , span [] [ text <| toString <| model.maxReach ]
            , span [ labelStyle ] [ text " MIN: "]
            , span [] [ text <| toString <| model.minReach ]
            , span [ labelStyle ] [ text " CLICKS: "]
            , span [] [ text <| toString <| model.clicks ]
            ]
        ]
